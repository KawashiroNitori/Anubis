...
export default class DomDialog extends DOMAttachedObject {
    ...
    static DOMAttachKey = 'anubisDomDialogInstance';
    ...
    async _show() {
        ...
        this.$dom.trigger('DomDialogShow');
        ...
        this.isShown = true;
        this.isAnimating = false;
        this.$dom.trigger('DomDialogShown');
    }

    async _hide() {
        this.$dom.trigger('DomDialogHide');
        this.isAnimating = true;
        ...
        this.isShown = false;
        this.isAnimating = false;
        this.$dom.trigger('DomDialogHidden');
    }
