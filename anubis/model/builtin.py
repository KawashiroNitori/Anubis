...
PERM_EDIT_CONTEST_SELF = 1 << 46
PERM_EDIT_CONTEST = 1 << 47
PERM_SEND_CONTEST_BALLOON = 1 << 48

# Training.
PERM_VIEW_TRAINING = 1 << 50
PERM_CREATE_TRAINING = 1 << 51
PERM_EDIT_TRAINING = 1 << 52
PERM_EDIT_TRAINING_SELF = 1 << 53

# Campaign
PERM_VIEW_CAMPAIGN = 1 << 56
...
PRIV_CREATE_CAMPAIGN = 1 << 20
PRIV_EDIT_CAMPAIGN = 1 << 21
PRIV_ATTEND_CAMPAIGN = 1 << 22
PRIV_ALL = -1

DEFAULT_PRIV = PRIV_USER_PROFILE | PRIV_CREATE_FILE | PRIV_DELETE_FILE_SELF | PRIV_ATTEND_CAMPAIGN
