...
import DummyPlugin from './scripts/build/webpackDummyPlugin';
import DummyOutputPlugin from './scripts/build/webpackDummyOutputPlugin';
import CopyWebpackPlugin from 'copy-webpack-plugin';
import postcssAutoprefixerPlugin from 'autoprefixer';
import stylusRupturePlugin from 'rupture';

import responsiveCutoff from './anubis/ui/responsive.inc'
...
function responsivePlugin() {
    return style => {
        style.define('responseCutoff', responsiveCutoff, true);
    }
}
...
export default function (env = {}) {
    const config = {
        ...
        plugins: [
            ...
            // don't include locale files in moment.js
            ...
            new CopyWebpackPlugin([{
                from: root('node_modules/emojify.js/dist/images/basic'),
                to: 'img/emoji/'
            }]),
        ],
